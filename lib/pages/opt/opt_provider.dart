...
import 'package:login_by_phone/services/safety/change_notifier_safety.dart';
...
class OptProvider extends ChangeNotifierSafety {
  ...
  Tuple2<bool, String> checkValidOPT(final BuildContext context,
      final String opt) {
    String optError = "";
    bool optValid = true;
    if (opt.isEmpty == true) {
  ...
  void onOPTChangeToValidateForm(final BuildContext context,
      final String opt) async {
